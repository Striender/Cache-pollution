...
def parse_champsim_file(filepath):
    ...
    metrics = {
        ...
        "L1D Load Miss": None, "L1D Load MPKI": None,"L1D Average MSHR Occupancy": None,
        ...
        "L2C Load Miss": None, "L2C Load MPKI": None,"L2C Average MSHR Occupancy": None,
        "L2C Prefetch Access": None, "L2C Prefetch Issued": None, "L2C Prefetch Useful": None, "L2C Useful Load Prefetches": None,
        "L2C Prefetch Accuracy": None, "L2C Average Miss Latency": None, "L2C Average Load Miss Latency": None, "L2C Late Prefetches": None,
        ...
        "LLC Load Miss": None, "LLC Load MPKI": None,"LLC Average MSHR Occupancy": None,
        "LLC Prefetch Access": None, "LLC Prefetch Issued": None, "LLC Prefetch Useful": None, "LLC Useful Load Prefetches": None,
        "LLC Prefetch Accuracy": None, "LLC Average Miss Latency": None, "LLC Average Load Miss Latency": None, "LLC Late Prefetches": None,
...
def main():
    ...
    """
    # --- CONFIGURATION ---
    RESULTS_DIR = "../results/results_spec/"
    OUTPUT_DIR = "/home2/neeraj/OneDrive/Research_Data/spec_workload"
    EXCEL_OUTPUT_FILE = "spec_data_dump_without_ppki_load.xlsx"
        ...
        for group_key in sorted(data_by_prefetcher.keys()):
            ...
            for experiment in experiments:
                ...
                for r_idx in range(current_row + 2, current_row + 2 + len(df_to_write)):
                    ...
                    worksheet[f"{l2c_updated_ipc_col}{r_idx}"] = f"=50000000/{l2c_new_cycles_col}{r_idx}"
                ...
                for r_idx in range(current_row + 2, current_row + 2 + len(df_to_write)):
                    ...
                    worksheet[f"{llc_updated_ipc_col}{r_idx}"] = f"=50000000/{llc_new_cycles_col}{r_idx}"
